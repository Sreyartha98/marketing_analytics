# The name of this view in Looker is "Demand Forecasting Prediction"
view: demand_forecasting_prediction {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `MarketingDataWarehouse.demand_forecasting_prediction`
    ;;
  ...
  dimension: predicted_total_amount_sold {
    type: number
    sql: ${TABLE}.predicted_total_amount_sold ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [store_name, item_name]
  }
}
