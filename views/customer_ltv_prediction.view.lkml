# The name of this view in Looker is "Customer Ltv Prediction"
view: customer_ltv_prediction {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `MarketingDataWarehouse.customer_ltv_prediction`
    ;;
  ...
  dimension: future_user_ltv_revenue {
    type: number
    sql: ${TABLE}.future_user_ltv_revenue ;;
  }
  ...
  dimension: predicted_future_user_ltv_revenue {
    type: number
    sql: ${TABLE}.predicted_future_user_ltv_revenue ;;
  }
