# The name of this view in Looker is "Purchase Propensity Train"
view: purchase_propensity_train {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `MarketingDataWarehouse.purchase_propensity_train`
    ;;
