# The name of this view in Looker is "Events Mod"
view: events_mod {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `MarketingDataWarehouse.events_mod`
    ;;
...
# The name of this view in Looker is "Events Mod Items"
view: events_mod__items {
  ...
  dimension: events_mod__items {
    type: string
    hidden: yes
    sql: events_mod__items ;;
  }
...
# The name of this view in Looker is "Events Mod Event Params"
view: events_mod__event_params {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_mod__event_params {
    type: string
    hidden: yes
    sql: events_mod__event_params ;;
  }
...
# The name of this view in Looker is "Events Mod User Properties"
view: events_mod__user_properties {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_mod__user_properties {
    type: string
    hidden: yes
    sql: events_mod__user_properties ;;
  }
