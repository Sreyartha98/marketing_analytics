# The name of this view in Looker is "Demand Forecasting Train"
view: demand_forecasting_train {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `MarketingDataWarehouse.demand_forecasting_train`
    ;;
